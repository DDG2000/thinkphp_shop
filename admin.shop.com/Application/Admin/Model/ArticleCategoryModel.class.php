...
class ArticleCategoryModel extends \Think\Model
{
    ...
    protected $_validate=array(
        array('name','require','文章分类名字不能为空'),
        array('name','','文章分类名字以存在',self::EXISTS_VALIDATE,'unique'),
    );
...
//        ->join('LEFT JOIN article_category on article.article_category_id article_category.id' )
