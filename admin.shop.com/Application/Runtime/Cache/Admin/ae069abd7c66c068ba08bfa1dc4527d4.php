...
<div id="header-div">
    <div id="logo-div" style="bgcolor:#000000;">
        <img src="http://admin.shop.com/Public/IMG/ecshop_logo.gif" alt="ECSHOP - power for e-commerce" />
    </div>
    <div id="submenu-div">
        <ul>
        ...
        <div id="send_info">
            ...
            <a href="<?php echo U('Admin/Admin/logout');?>" target="_top" class="fix-submenu">退出</a>
        </div>
    </div>
</div>
<div id="menu-div">
